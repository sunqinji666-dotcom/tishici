...
tishici は、個人の制作メモを保存する小さなセルフホスト型アーカイブです。プロンプトでは生成モデル、タイトル、本文、画像または動画を1枚のカードにまとめます。「随手記」には、短いメモ、タスク、画像、動画を残すための独立した入力欄と一覧があります。
...
- **素早く見返せる**：プロンプト、モデル、素材を同じカードに集め、最初の6件からスクロールで次のまとまりを自動表示します。
